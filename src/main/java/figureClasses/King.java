...
public class King extends Figure {
    ...
    public King(String path, VBox cell, GridPane tabla, String color) {
        ...
        LeftRook = new Rook("C:\\Users\\nezzr\\IdeaProjects\\chess\\src\\main\\resources\\ba\\games\\chess\\chess\\png\\" + color.toLowerCase() + "_rook.png", leftCell, tabla, color);
        VBox rightCell = (VBox) tabla.getChildren().get(rowIndex * 8 + 7);
        RightRook = new Rook("C:\\Users\\nezzr\\IdeaProjects\\chess\\src\\main\\resources\\ba\\games\\chess\\chess\\png\\" + color.toLowerCase() + "_rook.png", rightCell, tabla, color);
    }
